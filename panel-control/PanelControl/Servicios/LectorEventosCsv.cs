    ...
    private static RegistroEvento? ParsearLinea(string linea)
    {
        ...
        try
        {
            return new RegistroEvento
            {
                ...
                IpOrigen = campos[1],
                IpDestino = campos[2],
                PuertoOrigen = int.Parse(campos[3], CultureInfo.InvariantCulture),
                PuertoDestino = int.Parse(campos[4], CultureInfo.InvariantCulture),
                Protocolo = int.Parse(campos[5], CultureInfo.InvariantCulture),
                Duracion = double.Parse(campos[6], CultureInfo.InvariantCulture),
                PaquetesOrigen = int.Parse(campos[7], CultureInfo.InvariantCulture),
                PaquetesDestino = int.Parse(campos[8], CultureInfo.InvariantCulture),
                BytesOrigen = int.Parse(campos[9], CultureInfo.InvariantCulture),
                BytesDestino = int.Parse(campos[10], CultureInfo.InvariantCulture),
                TasaTransferencia = double.Parse(campos[11], CultureInfo.InvariantCulture),
                TtlOrigen = int.Parse(campos[12], CultureInfo.InvariantCulture),
                TtlDestino = int.Parse(campos[13], CultureInfo.InvariantCulture),
                CargaOrigen = double.Parse(campos[14], CultureInfo.InvariantCulture),
                CargaDestino = double.Parse(campos[15], CultureInfo.InvariantCulture),
                IntervaloOrigen = double.Parse(campos[16], CultureInfo.InvariantCulture),
                IntervaloDestino = double.Parse(campos[17], CultureInfo.InvariantCulture),
                FluctuacionOrigen = double.Parse(campos[18], CultureInfo.InvariantCulture),
                FluctuacionDestino = double.Parse(campos[19], CultureInfo.InvariantCulture),
                ConteoServicioOrigen = int.Parse(campos[20], CultureInfo.InvariantCulture),
                ConteoDestinoReciente = int.Parse(campos[21], CultureInfo.InvariantCulture),
                OrigPktsFlujo = long.Parse(campos[22], CultureInfo.InvariantCulture),
                OrigIpBytesFlujo = long.Parse(campos[23], CultureInfo.InvariantCulture),
                RespPktsFlujo = long.Parse(campos[24], CultureInfo.InvariantCulture),
                RespIpBytesFlujo = long.Parse(campos[25], CultureInfo.InvariantCulture),
                MissedBytes = int.Parse(campos[26], CultureInfo.InvariantCulture),
                Clasificador = campos[27],
                EsAmenaza = campos[28] == "1",
                Etiqueta = campos[29],
                Confianza = double.Parse(campos[30], CultureInfo.InvariantCulture),
                TiempoRespuestaMs = double.Parse(campos[31], CultureInfo.InvariantCulture),
                VeredictoIaEsAmenaza = campos[32] == "1",
                VeredictoIaConfianza = double.Parse(campos[33], CultureInfo.InvariantCulture),
            };
        }
